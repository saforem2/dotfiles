...
syn match   pythonComment       '#.*$' display contains=pythonTodo,pythonArgs,pythonKwargs,pythonReturns,pythonNote,@Spell
...
syn keyword pythonKwargs        Kwargs, KeywordArguments
...
" syn region pythonDocstring  start=+^\s*[uU]\?[rR]\?'''+ skip=+\\'+ end=+'''+ keepend contains=pythonEscape,@Spell,pythonDoctest,pythonDocTest2,pythonSpaceError,...
syn region pythonDocString start=+^\s*"""+ end=+"""+ keepend fold contains=pythonArgs,pythonKwargs,pythonReturns,pythonTodo,pythonNote,...
" HiLink pythonDocString        Comment
syn region pythonDocstring   start=+'''+ skip=+\\'+ end=+'''+ keepend fold contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,pythonDocTest,pythonSpaceError,@Spell
syn region pythonDocstring   start=+"""+ skip=+\\"+ end=+"""+ keepend fold contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,pythonDocTest2,pythonSpaceError,@Spell
...
" Regrexp for highlighting pythonFunctions
